...
<?php
    ...
    $total = array_sum(array_map(function($c) {
        ...
        /* if ($this->session->coupen_id):
           $makec = $c['p_l_char'] * (100 - $this->session->discount) / 100;
        endif; */
                        ...
                        <div class="order-summary-content">
                            ...
                            <div class="order-summary-table table-responsive text-center">
                                <table class="table table-bordered checkout">
                                    ...
                                    <tbody>
                                        <?php $disc = 0; foreach ($this->cart as $c): ?>
                                        <tr>
                                            <td>
                                            ...
                                            if (isset($this->session->coupen_id)):
                                                /* $makec = round($c['p_l_char'] * (100 - $this->session->discount) / 100); */
                                                $disc += round($c['p_l_char'] * ($this->session->discount) / 100) * $c['ca_qty'];
                                            endif;
                                    ...
                                    <tfoot>
                                    <?php if ($this->session->discount): ?>
                                    <tr>
                                        <td>Total Amount</td>
                                        <td class="pro-subtotal"><strong><i class="fa fa-inr" aria-hidden="true"></i> <?= $total ?></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Discount</td>
