<?php
    ...
    if(isset($_POST['submit']))
      ...
      move_uploaded_file($tempimage, "image/testimonial/$img");

    	$qry="INSERT INTO `testimonial`( `t_name`, `t_image`, `t_detail`) VALUES ('$name','$img','$detail')";
...
?>
       		<script>
       			...
       			window.open('add_testimonial.php','_self');
      		</script>
<?php
     	}
  	}
  ...
  <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
    <div class="container-fluid">
      <div class="navbar-wrapper">
        ...
        <a class="navbar-brand" href="javascript:;">Testimonial Foram</a>
      </div>
