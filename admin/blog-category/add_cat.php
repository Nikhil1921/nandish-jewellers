<?php
  ...
  { 
    if(isset($cid) && isset($data))
      $qry = "UPDATE `blog_category` SET `c_name` = '$name', `seo_title` = '$seo_title', `seo_description` = '$seo_description', `seo_keywords` = '$seo_keywords', `seo_detail` = '$detail' WHERE id = '$cid'";
    else
      $qry = "INSERT INTO `blog_category` (`c_name`, `seo_title`, `seo_description`, `seo_keywords`, `seo_detail`) VALUES ('$name', '$seo_title', '$seo_description', '$seo_keywords', '$detail')";
