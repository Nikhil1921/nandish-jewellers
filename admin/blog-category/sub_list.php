...
{
  $qry = "SELECT id FROM `blog_sub_category` WHERE id = '$pid'";
  ...
  if(!$data){
    ...
    $qry = "DELETE FROM `blog_sub_category` WHERE id = '$pid'";
          ...
          <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
              ...
              <td class="text-right">
                  ...
                  <a href="<?= $base_url ?>blog-category/sub_list.php?pid=<?= $data['id']; ?>&act=delete" class="btn btn-danger btn-link btn-icon"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
            <?php } ?>
            </tbody>
