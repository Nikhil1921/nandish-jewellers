<?php
  ...
  { 
    ...
    if(isset($cid) && isset($data))
      $qry = "UPDATE `blog_sub_inner_category` SET `si_name` = '$name', `i_id` = '$i_id', `s_id` = '$s_id', `c_id` = '$c_id', `seo_title` = '$seo_title', `seo_description` = '$seo_description', `seo_keywords` = '$seo_keywords', `seo_detail` = '' WHERE id = '$cid'";
    else
      $qry = "INSERT INTO `blog_sub_inner_category` (`si_name`, `i_id`, `s_id`, `c_id`, `seo_title`, `seo_description`, `seo_keywords`, `seo_detail`) VALUES ('$name', '$i_id', '$s_id', '$c_id', '$seo_title', '$seo_description', '$seo_keywords', '')";
